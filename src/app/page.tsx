    ...
    <>
      ...
      <main className='mb-[124px]'>
        ...
        <div>
          ...
          <ul className='text-lg mb-[41px] text-justify ml-[22px] list-disc list-inside'>
            {result[0].meanings[0].definitions.map((defs: any) => {
              return <li key={defs.definition}>{defs.definition}</li>
            })}
          </ul>
